		...
		<>
			...
			<Container>
				<Header>
					...
					<Text>
						Precisamos de mais algumas informações para criar seu perfil. Ah, você pode editar essas informações depois!
					</Text>
				...
				<Form as="form" onSubmit={handleSubmit(handleRegister)}>
					<label>
						...
						{errors.username?.message ? <FormError size="sm">{errors.username?.message}</FormError> : <Space />}
					</label>
					...
					<label>
						...
						{errors.username?.message ? <FormError size="sm">{errors.name?.message}</FormError> : <Space />}
					</label>
